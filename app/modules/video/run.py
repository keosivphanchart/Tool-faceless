...
Usage:
    python -m app.modules.video.run <script_id> [--dry-run]
"""
import argparse
import logging
...
from app.modules.video.assemble import assemble_video, build_background, generate_thumbnail
from app.modules.video.captions import generate_captions
from app.modules.video.metadata import write_metadata
from app.modules.video.stock_footage import fetch_background_clips
from app.modules.voice.run import generate_voiceover, script_to_narration_text
from app.modules.review.notify import notify_video_ready
